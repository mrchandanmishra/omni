          ...
          <div className="max-w-md mx-auto bg-gray-800 rounded-2xl p-6 space-y-4">
            ...
            <div className="bg-gray-700 rounded-xl p-4 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                />
                <button className="bg-gray-600 text-gray-300 px-3 py-1 rounded-md text-sm hover:bg-gray-500">
                  Max
                </button>
              </div>
            </div>
            ...
            <button className="w-full bg-gray-600 text-white py-4 rounded-xl font-medium hover:bg-gray-500 transition-colors">
              Select network
            </button>
          </div>
        </div>
